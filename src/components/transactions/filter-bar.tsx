...
import { useTransactionFilters } from "@/features/filters/store";
...
export function FilterBar({
  ...
  return (
    <div className="flex flex-col gap-0 overflow-hidden rounded-2xl border border-white/20 bg-white/[0.06] shadow-[var(--shadow-card)] backdrop-blur-md">
      {/* Field strip */}
      ...
      <div className="space-y-3 px-4 py-5 sm:px-5">
        ...
        <p className="max-w-3xl text-xs leading-relaxed text-zinc-500">
          ...
          matches that calendar month across every year (month is compared in
          UTC, same as charts).{" "}
          <strong className="font-medium text-zinc-400">Last month</strong> is
          the full previous calendar month only. Default is all time.
        </p>
