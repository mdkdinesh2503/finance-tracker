...
/** Mirrors `TransactionsAccordion` year → month → table structure. */
        ...
        <div className="mt-5 space-y-3 pl-0 sm:pl-11">
          <div className="overflow-hidden rounded-xl border border-white/12 bg-[color-mix(in_srgb,var(--surface)_88%,transparent)]">
            <div className="flex gap-3 p-4 sm:gap-4">
              ...
              <Skeleton className="h-9 w-28 shrink-0 rounded-full self-center" />
            </div>
            <div className="border-t border-white/10 bg-black/20 px-2 py-3">
              ...
              <div className="space-y-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex gap-2 rounded-lg border border-white/[0.06] bg-white/[0.02] px-3 py-2.5"
                  >
