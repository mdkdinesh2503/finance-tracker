...
export function MainNav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--header-border)] bg-[var(--header-bg)] shadow-[0_4px_24px_rgba(0,0,0,0.35)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center gap-2 px-3 py-2.5">
        <div className="flex min-w-0 flex-1 justify-start">
          ...
          >
            ...
            <span className="text-[var(--ink-muted)]">Tracker</span>
          </Link>
        </div>
