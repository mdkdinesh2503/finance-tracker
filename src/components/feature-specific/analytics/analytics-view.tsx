...
import { CategoryVsLastMonth } from "./category-vs-last-month";
import { MonthlyTrendChart } from "./analytics-charts";
import {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4 border-t border-white/10 pt-8">
        ...
        <p className="text-sm text-zinc-500">
          All calendar months in your data, with income, expense, and investment
          per month.
        </p>
