...
const COLORS = ["#2563eb", "#22c55e", "#f97316", "#38bdf8", "#f43f5e", "#eab308", "#3b82f6"];
...
export function MonthlyTrendChart({ data }: { data: TrendRow[] }) {
  if (data.length === 0) {
    return <p className="py-12 text-center text-sm text-zinc-500">No data for this range.</p>;
  }
  return (
  ...
  return (
    <ResponsiveContainer width="100%" height={320}>
      <BarChart data={data} layout="vertical" margin={{ left: 8, right: 16 }}>
        ...
        <YAxis type="category" dataKey="name" width={120} stroke="#a1a1aa" fontSize={11} />
        <Tooltip
          contentStyle={{
            background: "rgba(10,12,16,0.96)",
            border: "1px solid rgba(37,99,235,0.25)",
